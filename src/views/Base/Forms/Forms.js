...
class Forms extends Component {
  constructor(props) {
    super(props);
    this.save_to_db_drivers = this.save_to_db_drivers.bind(this);
    this.view_from_db_drivers = this.view_from_db_drivers.bind(this);
    this.save_to_db_buses = this.save_to_db_buses.bind(this);
    this.view_from_db_buses = this.view_from_db_buses.bind(this);
  ...
  save_to_db_drivers(){
    ...
    rootRef.push().set({
      ...
      nplate: document.getElementById("nplate").value,
  ...
  view_from_db_drivers(){
    ...
    rootRef.on("value", function(snapshot) {
      ...
      console.log(res);
      // ReactDOM.render(res, document.getElementById('results')); //this should eventually work as we plan to display the results on screen
  ...
  save_to_db_buses(){
    ...
    rootRef.push().set({
      ...
      numofseats: document.getElementById("numofseats").value,
      ...
      <div className="animated fadeIn">
            ...
            <Card>
              ...
              <CardBody>
                <FormGroup>
                  ...
                  <Input type="text" id="Car_Model" placeholder="Enter your Car Model" />
                </FormGroup>

                <FormGroup>
                  <Label htmlFor="KRA pin">KRA pin</Label>
                  <Input type="text" id="KRA_pin" placeholder="Enter Your KRA Pin DE1234567890" />
                </FormGroup>

                <FormGroup>
                  <Label htmlFor="Next Of Kin">Next Of Kin</Label>
                  <Input type="text" id="NOK" placeholder="Enter Name of Next Of Kin" />
                </FormGroup>
                ...
                <FormGroup row className="my-0">
                  <Col xs="6">
                    <FormGroup>
                      ...
                      <Input type="text" id="fname" placeholder="Enter Drivers First Name" />
                    </FormGroup>
                  </Col>
                  <Col xs="6">
                    <FormGroup>
                      <Label htmlFor="last-code">Second Name</Label>
                      <Input type="text" id="lname" placeholder="Enter Driver Last Name" />
                    </FormGroup>
                  </Col>
                </FormGroup>
                ...
                <FormGroup>
                  ...
                  <Input type="text" id="mnumber" placeholder="Enter Driver Mobile Number" />
                </FormGroup>

                <FormGroup>
                  <Label htmlFor="residence">Residence</Label>
                  <Input type="text" id="residence" placeholder="Driver Residence" />
                </FormGroup>
                ...
                <FormGroup row className="my-0">
                  <Col xs="6">
                    <FormGroup>
                      ...
                      <Input type="text" id="noofseats" placeholder="Number of Seats in vehiecle" />
                    </FormGroup>
                  </Col>
                  <Col xs="6">
                    <FormGroup>
                      <Label htmlFor="Number Plate">Number Plate</Label>
                      <Input type="text" id="nplate" placeholder="Enter Vehiecle Number Plate" />
                    </FormGroup>
                  </Col>
                </FormGroup>

                <FormGroup>
                  <Label htmlFor="Picture Of Driver ">Driver's Picture</Label>
                  <Input type="text" id="POD" placeholder="Upload Profile picture" />
                </FormGroup>

                <CardFooter>
                  <Button type="submit" size="sm" color="primary" id=" save_button" onClick={this.save_to_db_drivers}><i className="fa fa-dot-circle-o"></i> Submit</Button>
                  <Button type="reset" size="sm" color="danger" id=" load_button" onClick={this.view_from_db_drivers}><i className="fa fa-ban"></i> Load</Button>{/*have this for now we will change later */}
              </CardFooter>
              </CardBody>
            </Card>
          </Col>
        ...
        <Row>
          ...
          <Col xs="12" md="6">
            <Card>
              <CardHeader>
                <strong>Register Buses</strong> Form
              </CardHeader>
              <CardBody>

              <FormGroup>
                  <Label htmlFor="Picture of vehiecle">Picture Of Vehiecle</Label>
                  <Input type="text" id="POV" placeholder="Upload Vehiecles Picture" />
                </FormGroup>
                ...
                <FormGroup row className="my-0">
                  <Col xs="6">
                    <FormGroup>
                      <Label htmlFor="first name">First Name</Label>
                      <Input type="text" id="dname" placeholder="Enter Drivers First Name" />
                    </FormGroup>
                  </Col>
                  <Col xs="6">
                    <FormGroup>
                      <Label htmlFor="last Name">Last Name</Label>
                      <Input type="text" id="pname" placeholder="Enter Driver Last Name" />
                    </FormGroup>
                  </Col>
                </FormGroup>
                ...
                <FormGroup>
                  <Label htmlFor="Mobile Number">Mobile Number</Label>
                  <Input type="text" id="mobnumber" placeholder="Enter Drivers Mobile Number" />
                </FormGroup>
                ...
                <FormGroup row className="my-0">
                  <Col xs="6">
                    <FormGroup>
                      <Label htmlFor="Number Of Seats">Number Of Seats</Label>
                      <Input type="text" id="numofseats" placeholder="Enter Vehiecles Number Of Seats" />
                    </FormGroup>
                  </Col>
                  <Col xs="6">
                    <FormGroup>
                      <Label htmlFor="Number Plate">Number Plate</Label>
                      <Input type="text" id="numplate" placeholder="Enter Vehiecles Number Plate" />
                    </FormGroup>
                  </Col>
                </FormGroup>

                <FormGroup>
                  <Label htmlFor="Vehiecle Coordinates">vehiecle Coordinates</Label>
                  <Input type="text" id="position" placeholder="Enter current vehiecle coordinates" />{/*for now(need to lok for sensor) */}
                </FormGroup>

              </CardBody>

              <CardFooter>
                <Button type="submit" size="sm" color="primary" id=" save_button" onClick={this.save_to_db_buses} ><i className="fa fa-dot-circle-o"></i> Submit</Button>
                <Button type="reset" size="sm" color="danger"><i className="fa fa-ban" id=" load_button" onClick={this.view_from_db_buses} ></i> Load</Button>
              </CardFooter>
            </Card>
